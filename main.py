...
file_path = (
    "dbfs:/FileStore/tables/your-output-directory/"
    "part-00000-tid-6687512951801856408-77285f10-1c38-4edc-92e1-"
    "f3f07f756634-9-1-c000.snappy.parquet"
)
...
transformed_df = (
    birds_df.groupBy("scientific_name")
    .agg(count("class_id").alias("image_count"))
)
